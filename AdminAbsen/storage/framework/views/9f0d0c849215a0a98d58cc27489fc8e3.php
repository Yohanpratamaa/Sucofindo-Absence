...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.badge','data' => ['color' => $todayAttendance->check_out ? 'success' : 'warning']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($todayAttendance->check_out ? 'success' : 'warning')]); ?>
                            <?php echo e($todayAttendance->check_out ? 'Sudah Check Out' : 'Sudah Check In'); ?>
...
<?php $component->withAttributes([]); ?>
             <?php $__env->slot('heading', null, []); ?> 
                <?php echo e($canCheckIn ? 'Check In WFO' : ($canCheckOut ? 'Check Out WFO' : 'Absensi WFO')); ?>

             <?php $__env->endSlot(); ?>

             <?php $__env->slot('description', null, []); ?> 
                <!--[if BLOCK]><![endif]--><?php if($canCheckIn): ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($canCheckIn || $canCheckOut): ?>
                <!-- Camera Status Alert -->
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['id' => 'test-size-btn','type' => 'button','outlined' => true,'color' => 'warning','icon' => 'heroicon-m-scale','style' => 'display: none;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'test-size-btn','type' => 'button','outlined' => true,'color' => 'warning','icon' => 'heroicon-m-scale','style' => 'display: none;']); ?>
                        Cek Ukuran
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php $component->withAttributes(['id' => 'submit-btn','type' => 'button','color' => 'success','icon' => 'heroicon-m-check-circle','style' => 'display: none;']); ?>
                        <?php echo e($canCheckIn ? 'Check In Sekarang' : 'Check Out Sekarang'); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['tag' => 'a','href' => url('/pegawai/my-attendances'),'outlined' => true,'color' => 'primary','icon' => 'heroicon-m-clock']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/pegawai/my-attendances')),'outlined' => true,'color' => 'primary','icon' => 'heroicon-m-clock']); ?>
...
<script>
    ...
    const offices = <?php echo json_encode($this->getOffices(), 15, 512) ?>;
    ...
    function submitAttendance() {
        ...
        const isCheckIn = <?php echo e($canCheckIn ? 'true' : 'false'); ?>;

        if (isCheckIn) {
            console.log('Calling processCheckIn...');
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('processCheckIn', capturedPhoto, currentLocation.latitude, currentLocation.longitude)
                .then((result) => {
                ...
                .catch((error) => {
                    ...
                    submitBtn.textContent = '<?php echo e($canCheckIn ? "Check In Sekarang" : "Check Out Sekarang"); ?>';
                    showNotification('Error: ' + error.message, 'danger');
                });
        } else {
            console.log('Calling processCheckOut...');
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('processCheckOut', capturedPhoto, currentLocation.latitude, currentLocation.longitude)
                .then((result) => {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\Sucofindo-Absen\AdminAbsen\resources\views/filament/pegawai/pages/wfo-attendance.blade.php ENDPATH**/ ?>