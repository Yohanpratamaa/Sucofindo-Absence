    ...
    <style>
        ...
        .bg-with-image {
            background-image:
                ...
                url('<?php echo e(asset('images/background.png')); ?>');
...
<body class="bg-with-image bg-fallback flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md login-card rounded-2xl p-8 relative z-10">
        ...
        <!-- Login Form -->
        <form method="POST" action="<?php echo e(route('unified.login')); ?>" class="space-y-6 slide-up">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Sucofindo-Absen\AdminAbsen\resources\views/auth/unified-login.blade.php ENDPATH**/ ?>